    ...
    private class SpeleologistMovePerformer extends CyclicBehaviour {
        public void action() {
            ...
            if (msg != null) {
                ...
                AID current_Speleologist = msg.getSender();
                Coords Speleologist_coords = Speleologists.get(current_Speleologist);
                System.out.println("World say: Current agent coords: " + Speleologist_coords.row +
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                if (Speleologist_coords == null){
                    ...
                    if (wampusMap[Speleologist_coords.row][Speleologist_coords.column]
